<!-- TOC -->autoauto- [MySQL学习笔记](#mysql学习笔记)auto    - [配置](#配置)auto        - [字符集](#字符集)auto        - [常用配置](#常用配置)auto    - [文件结构](#文件结构)auto    - [架构](#架构)auto        - [插件式存储引擎](#插件式存储引擎)auto        - [存储引擎](#存储引擎)auto    - [Join](#join)auto    - [索引](#索引)auto    - [SQL优化](#sql优化)auto        - [SQL性能影响因素](#sql性能影响因素)auto        - [MySQL性能瓶颈](#mysql性能瓶颈)auto        - [explain](#explain)auto        - [索引优化分析](#索引优化分析)auto        - [查询截取分析](#查询截取分析)auto            - [总体思路](#总体思路)auto            - [慢查询](#慢查询)auto            - [show profiles](#show-profiles)auto            - [全局查询日志](#全局查询日志)auto    - [锁](#锁)auto        - [分类](#分类)auto        - [案例](#案例)auto            - [MyISAM表锁](#myisam表锁)auto            - [InnoDB行锁](#innodb行锁)auto        - [事务](#事务)auto            - [ACID](#acid)auto            - [并发事务问题](#并发事务问题)auto            - [事务隔离级别](#事务隔离级别)auto    - [主从复制](#主从复制)auto        - [原理](#原理)autoauto<!-- /TOC -->
# MySQL学习笔记
